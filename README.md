...
##### *pop() — снять верхний элемент (удалить);
...
### Очередь (Queue) Принцип: FIFO — First In, First Out.
#### Операции:
##### *enqueue(x) — добавить в конец;
##### *dequeue() — взять элемент из начала (и удалить);
...
#### Основные идеи:
##### элементы не хранятся подряд в памяти, как в массиве; каждый элемент знает только «следующего соседа».
#### Плюсы:
